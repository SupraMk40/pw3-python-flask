...
import uuid #gera um nome aleatorio para o arquivo
...
def init_app(app):
    ...
    def galeria():
        FYLE_TYPES = set(['png', 'jpg', 'jpeg', 'gif', 'webp', 'svg'])
        def arquivos_permitidos(filename):
            return '.' in filename and filename.rsplit('.', 1)[1].lower() in FYLE_TYPES
        if request.method == 'POST':
            ...
            flash("Imagem recebido com sucesso", 'success')
